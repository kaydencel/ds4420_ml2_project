...
price_data      <- readRDS("../models/price_model_data.rds")
ghost_data      <- readRDS("../models/ghost_model_data.rds")
df_ghost        <- readRDS("../models/df_ghost_data.rds")
borough_medians <- readRDS("../models/borough_medians.rds")
fl              <- readRDS("../models/factor_levels.rds")
